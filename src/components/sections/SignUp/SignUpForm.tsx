...
const schema = z
	.object({
		...
		confirmPassword: z.string().min(8, 'Senha é obrigatório'),
	})
...
export default function SignUpForm() {
	...
	const handleSubmit = hookFormHandleSubmit(async (data) => {
		...
		const bodyOmie = {
			param: [
				{
					codigo_cliente_integracao: data.document,
	...
	return (
		<form
			...
			className='bg-white rounded-md px-8 py-8 flex items-center justify-center flex-col absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] shadow-md'
		>
			...
			<div className='flex gap-5 w-full'>
				<div className='grid w-full items-center gap-1.5 mb-4'>
					...
					<Input id='document' placeholder='CPF' {...register('document')} />
