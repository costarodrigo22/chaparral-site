...
export default function SignUpForm() {
  ...
  return (
    <form
      ...
      className="bg-white rounded-md px-8 py-8 flex items-center justify-center flex-col absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[25%] sm:-translate-y-[1/2] w-full sm:w-[700px] shadow-md"
    >
